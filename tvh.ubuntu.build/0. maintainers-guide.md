...
*As part of the image building process on Dockerhub, our Dockerfiles contain the necessary instructions to auto-upload and auto-publish the resulting .deb files to bintray.com. So all of the work is done by setting up a build chain workflow.*
