...
my %formats = (
	...
	# Fix: nm2.pl overrides the theme's pubmsg_me variable when loaded
    pubmsg_me		   => [0, '%M%0{pubmsgmenick '   ,'%M%0$2',' {menick '    ,'$0','}',''               ,'}','$1' ],
    pubmsg_me_channel	   => [0, '%M%0{pubmsgmenick '   ,'%M%0$3',' {menick '    ,'$0','}','{msgchannel $1}','}','$2' ],
    pubmsg_hilight	   => [0, '%M%0{pubmsghinick $0 ','%M%0$3',' '            ,'$1', '','',              ,'}','$2' ],
    pubmsg_hilight_channel => [0, '%M%0{pubmsghinick $0 ','%M%0$4',' '            ,'$1', '','{msgchannel $2}','}','$3' ],
