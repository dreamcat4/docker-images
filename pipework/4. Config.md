...
Comma seperated list of event filtering arguments. Can be used to restrict the set of containers which pipework inspects. And containers which do not match the criteria will be ignored.

BE AWARE OF DOUBLE QUOTING. Often times, the extra quotes being shown here are not needed. For example:
